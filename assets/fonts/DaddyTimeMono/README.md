 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [DaddyTimeMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/DaddyTimeMono.zip)
   * [DaddyTimeMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/DaddyTimeMono.tar.xz) (smaller)
