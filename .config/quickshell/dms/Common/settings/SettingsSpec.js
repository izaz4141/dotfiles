...
var SPEC = {
    ...
    inputSettings: { def: { hyprland: { kb_layout: "us", follow_mouse: 1, sensitivity: 0, touchpad: { natural_scroll: true, tap_to_click: true, disable_while_typing: false } } }, onChange: "updateCompositorCursor" },
    ...
    acProfileName: { def: "" },
    acBrightnessLevel: {def : 5},
    batteryBrightnessLevel: {def : 5},
    acBrightnessTimeout: {def : 0},
    batteryBrightnessTimeout: {def : 0},
    ...
    toolboxAiModel: { def: "" },
    toolboxAiTextFadeIn: { def: false },
    toolboxAiSearchEngineBaseUrl: { def: "https://www.google.com/search?q=" },
    toolboxAiSearchExcludedSites: { def: ["quora.com", "facebook.com"] },
    toolboxBooruProvider: { def: "yandere" },
    toolboxBooruLimit: { def: 20 },
    toolboxBooruAllowNsfw: { def: false },
