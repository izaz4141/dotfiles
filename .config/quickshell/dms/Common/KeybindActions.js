...
const DMS_ACTIONS = [
    ...
    { id: "spawn qs ipc call toolbox toggle", label: "Toolbox: Toggle" },
    { id: "spawn qs ipc call toolbox open", label: "Toolbox: Open" },
    { id: "spawn qs ipc call toolbox close", label: "Toolbox: Close" },
    ...
    { id: "spawn dms ipc call screenshot controls", label: "Screenshot: Controls" },
