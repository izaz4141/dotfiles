...
Column {
    ...
    signal networkSpeedSettingChanged(string sectionId, int widgetIndex, string settingName, var value)
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        DankActionButton {
                            id: networkSpeedMenuButton
                            visible: modelData.id === "network_speed_monitor"
                            buttonSize: 32
                            iconName: "more_vert"
                            iconSize: 18
                            iconColor: Theme.outline
                            onClicked: {
                                networkSpeedContextMenu.widgetData = modelData;
                                networkSpeedContextMenu.sectionId = root.sectionId;
                                networkSpeedContextMenu.widgetIndex = index;

                                var buttonPos = networkSpeedMenuButton.mapToItem(root, 0, 0);
                                var popupWidth = networkSpeedContextMenu.width;
                                var popupHeight = networkSpeedContextMenu.height;

                                var xPos = buttonPos.x - popupWidth - Theme.spacingS;
                                if (xPos < 0)
                                    xPos = buttonPos.x + networkSpeedMenuButton.width + Theme.spacingS;

                                var yPos = buttonPos.y - popupHeight / 2 + networkSpeedMenuButton.height / 2;
                                if (yPos < 0) {
                                    yPos = Theme.spacingS;
                                } else if (yPos + popupHeight > root.height) {
                                    yPos = root.height - popupHeight - Theme.spacingS;
                                ...
                                networkSpeedContextMenu.x = xPos;
                                networkSpeedContextMenu.y = yPos;
                                networkSpeedContextMenu.open();
                            }
                        }
            ...
            Column {
                ...
                Rectangle {
                    ...
                    StyledText {
                        ...
                        anchors.leftMargin: Theme.spacingS
                        anchors.verticalCenter: parent.verticalCenter
                        text: I18n.tr("Network Speed Monitor Settings")
                        font.pixelSize: Theme.fontSizeSmall
                        font.weight: Font.Medium
                        color: Theme.surfaceText
                    }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: interfaceArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    DankDropdown {
                        ...
                        options: {
                            var opts = [I18n.tr("All Interfaces")];
                            if (NetworkSpeedService.networkInterfaces) {
                                for (var i = 0; i < NetworkSpeedService.networkInterfaces.length; i++) {
                                    opts.push(NetworkSpeedService.networkInterfaces[i].name);
                                }
                            }
                            return opts;
                        }
                        onValueChanged: value => {
                            const newValue = value === I18n.tr("All Interfaces") ? "all" : value;
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "selectedInterface", newValue);
                        }
                    }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: updateIntervalArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    DankSlider {
                        ...
                        onValueChanged: {
                            ...
                            NetworkSpeedService.updateInterval = value;
                        }
                    }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: showIconArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    DankToggle {
                        ...
                        width: 40
                        height: 20
                        checked: networkSpeedContextMenu.currentWidgetData?.showIcon !== false
                        onToggled: {
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "showIcon", toggled);
                        }
                    }
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onPressed: {
                            showIconToggle.checked = !showIconToggle.checked;
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "showIcon", showIconToggle.checked);
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: showLabelsArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    DankToggle {
                        ...
                        width: 40
                        height: 20
                        checked: networkSpeedContextMenu.currentWidgetData?.showLabels !== false
                        onToggled: {
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "showLabels", toggled);
                        }
                    }
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onPressed: {
                            showLabelsToggle.checked = !showLabelsToggle.checked;
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "showLabels", showLabelsToggle.checked);
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: compactArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    Row {
                        ...
                        StyledText {
                            text: I18n.tr("Compact Mode (Horizontal)")
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceText
                            font.weight: Font.Normal
                            anchors.verticalCenter: parent.verticalCenter
                    ...
                    DankToggle {
                        ...
                        width: 40
                        height: 20
                        checked: networkSpeedContextMenu.currentWidgetData?.compactMode || false
                        onToggled: {
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "compactMode", toggled);
                        }
                    }
                    ...
                    MouseArea {
                        ...
                        onPressed: {
                            ...
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "compactMode", compactToggle.checked);
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: Theme.cornerRadius
                    color: precisionArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                    ...
                    DankDropdown {
                        ...
                        options: [I18n.tr("0 decimals"), I18n.tr("1 decimals"), I18n.tr("2 decimals")]
                        onValueChanged: value => {
                            const newValue = parseInt(value.split(" ")[0]);
                            root.networkSpeedSettingChanged(networkSpeedContextMenu.sectionId, networkSpeedContextMenu.widgetIndex, "unitPrecision", newValue);
                        }
                    }
