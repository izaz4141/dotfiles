...
Item {
    ...
    ShaderEffectSource {
        ...
        sourceItem: wallpaperBackground
        height: parent.height
        width: parent.width / 3
    ...
    Rectangle {
        ...
        Clock {
            id: clock
            anchors.left: parent.left
            anchors.leftMargin: (form.width - width) / 2
        ...
        Rectangle {
            ...
            color: "black"
            opacity: 0.5
            width: bottomRowContainer.width + Theme.spacingL * 2
            height: bottomRowContainer.height + Theme.spacingL * 2
            visible: MprisController.activePlayer || root.randomFact !== ""
            topLeftRadius: Theme.spacingL
        }
        ...
        SystemButtons {
            id: systemButtons
            anchors.left: parent.left
            anchors.leftMargin: (blur.width - width) / 2
            anchors.top: parent.top
