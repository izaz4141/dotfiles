...
local function default_config()
    return {
        communication = {
            discord  = { enable = true, match = { { class = "discord" } }, move = true },
            zapzap  = { enable = true, match = { { initial_class = "com.rtosta.zapzap" }, { initial_title = "ZapZap" } }, move = true },
            ferdium = { enable = true, match = { { class = "ferdium" } }, command = { "Ferdium" }, move = true },
        },
        music = {
            spotify = {
                enable  = false,
            ...
            feishin = { enable = false, match = { { class = "feishin" } }, move = true },
        },
        sysmon = {
            btop = {
                enable  = true,
