return {
    primary_paletteKeyColor         = "{{colors.primary_container.default.hex_stripped}}",
    secondary_paletteKeyColor       = "{{colors.secondary_container.default.hex_stripped}}",
    tertiary_paletteKeyColor        = "{{colors.tertiary_container.default.hex_stripped}}",
    neutral_paletteKeyColor         = "{{colors.surface.default.hex_stripped}}",
    neutral_variant_paletteKeyColor = "{{colors.surface_variant.default.hex_stripped}}",
